...
def get_all_accounts_by_customer_id(customer_id):
    return AccountService.get_all_accounts_by_customer_id(customer_id)
...
def add_account():
    ...
    account_object = Account(None, account_json_dictionary['account_balance'], account_json_dictionary['customer_id'],
                             None)
    try:
